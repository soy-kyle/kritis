...
type FakeVulnzSigningPolicies struct {
	Fake *FakeKritisV1beta1
	ns   string
}

var vulnzsigningpoliciesResource = schema.GroupVersionResource{Group: "kritis", Version: "v1beta1", Resource: "vulnzsigningpolicies"}
...
func (c *FakeVulnzSigningPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.VulnzSigningPolicy, err error) {
	...
	return obj.(*v1beta1.VulnzSigningPolicy), err
}
