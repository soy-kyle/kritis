...
type FakeAttestationAuthorities struct {
	Fake *FakeKritisV1beta1
	ns   string
}

var attestationauthoritiesResource = schema.GroupVersionResource{Group: "kritis", Version: "v1beta1", Resource: "attestationauthorities"}
